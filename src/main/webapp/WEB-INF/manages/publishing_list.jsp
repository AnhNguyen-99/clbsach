...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">Danh sách NXB</h1>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-12">
							...
							<div class="panel-body">
								<div class="table-responsive">
									<table class="table table-striped table-bordered table-hover"
										...
										<tbody>
											<c:forEach items="${listPublishing}" var="item">
												<tr>
													<td>${item.publishingId}</td>
													<td>${item.publishingName}</td>
													<td>${item.address}</td>
													<td>${item.createDate}</td>
													<td><a class='btn btn-default'
														href='${pageContext.request.contextPath}/manages/publishing/update/${item.publishingId}'><i
															class='fa fa-edit'></i></a>
														<p class='btn btn-default'
															onclick='checkdel(${item.publishingId})'>
	...
	<script>
        function checkdel(publishingId) {
            var publishingId = publishingId;
            var link = "${pageContext.request.contextPath}/manages/publishing/delete/" + publishingId;
