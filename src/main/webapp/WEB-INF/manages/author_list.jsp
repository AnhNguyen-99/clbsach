...
<body>
											...
											<c:forEach items="${listAuthor}" var="item">
												<tr>
													...
													<td><a class='btn btn-default'
														href='${pageContext.request.contextPath}/manages/author/update/${item.authorId}'><i
															class='fa fa-edit'></i></a>
														<p class='btn btn-default'
															onclick='checkdel(${item.authorId})'>
	...
	<script>
        function checkdel(authorId) {
            var authorId = authorId;
            var link = "${pageContext.request.contextPath}/manages/author/delete/" + authorId;
