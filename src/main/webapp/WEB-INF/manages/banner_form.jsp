				...
				<div class="row">
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">Tạo banner mới</div>
							<div class="panel-body">
								<div class="row">
									<div class="col-lg-12">
										<!-- Form tạo danh mục -->
										<form:form action="${pageContext.request.contextPath}/manages/banner/save" method="POST" modelAttribute="banner" enctype="multipart/form-data">
											<form:input path="bannerId" type="hidden"/>
											<div class="form-group">
												<label>Ảnh banner</label>
												<img style="text-align: center;" src="${pageContext.request.contextPath}/resources/page/img/banner/${item.image}" alt="${item.image}" height="150px" width="150px"> 
