				...
				<div class="row">
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">Tạo NXB mới</div>
							<div class="panel-body">
								<div class="row">
									<div class="col-lg-12">
										<!-- Form tạo danh mục -->
										<form:form action="${pageContext.request.contextPath}/manages/publishing/save" method="POST" modelAttribute="publishing">
											<div class="form-group">
												<label>Tên NXB</label>
												 <form:input class="form-control" type="text" path="publishingName"/>
											</div>
											<div class="form-group">
												<label>Địa chỉ</label>
