...
<body>
											...
											<c:forEach items="${listNews}" var="item">
												<tr>
													...
													<td><a class='btn btn-default'
														href='${pageContext.request.contextPath}/manages/news/update/${item.newsId}'><i
															class='fa fa-edit'></i></a>
														<p class='btn btn-default'
															onclick='checkdel(${item.newsId})'>
	...
	<script>
        function checkdel(newsId) {
            var newsId = newsId;
            var link = "${pageContext.request.contextPath}/manages/news/delete/" + newsId;
